...
const ICPCTeamPoster = () => {
  ...
  const avgRating = Math.round(teamData.members.reduce((sum, m) => sum + m.currentRating, 0) / 3);
  const peakRating = Math.max(...teamData.members.map(m => m.maxRating));
                  ...
                  <div className="team-stats">
                    <div className="stats-grid">
                      <div className="stat-item with-border">
                        <div className="rating-value stat-value avg-rating">{avgRating}</div>
                        <div className="stat-label">AVG RATING</div>
                      </div>
                      <div className="stat-item">
                        <div className="rating-value stat-value peak-rating">{peakRating}</div>
                          ...
                          <div className="player-content">
                            ...
                            <div className="player-stats">
                              <div className="stat-box">
                                ...
                                <div className="rating-label">CURRENT</div>
                              </div>
                              ...
                              <div className="stat-box">
                                ...
                                <div className="rating-label">MAX</div>
                              </div>
                            </div>
                          </div>
                        </div>
